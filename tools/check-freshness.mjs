...
// רק הודעות של קומיטים אוטומטיים. לא "רענון" לבדה — היא מופיעה גם בקומיטים
// אנושיים ("...+ רענון תמונת המצב") והייתה מדלגת עליהם ומזייפת את גיל התוכן.
const AUTO_MSG = /(עדכון אוטומטי של knowledge|תבנית אחת לתפריט|build-nav|רענון תבנית|רענון אוטומטי|knowledge\.json)/;
