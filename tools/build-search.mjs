...
const SKIP = new Set([
  ...
  "ishur-tochnit.html",   // אישור תוכניות הגמר — נפתח רק בקישור אישי עם מפתח
  "ishur-tochniyot-dash.html", // דשבורד אישור התוכניות — קישור ניהול עם מפתח
  "bagmgr.html",
  "chipus.html",
  "work-plans-app.html",
  ...
  "nispach-baaley-tafkidim.html", // נספח בעלי התפקידים — טופס למנהלים, לא מקושר מהאתר
  "sikum-nispach-tafkidim.html",  // מעקב מילוי הנספח — לרויטל, לא מקושר מהאתר
  "merkaz-tofsim.html",  // מרכז הטפסים והמעקב — עמוד פנימי לרויטל ולמיטל
...
const CAT_OF = {
  ...
  "preda-yb.html": "pedagogi",
  "bikur-sadir.html": "nehalim",
  "michtav-kabas.html": "nehalim",
  "michtav-aklim.html": "nehalim",
  "hachala.html": "nehalim",
