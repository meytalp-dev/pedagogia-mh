...
(function () {
  ...
  var CSS = [
    ...
    '.sktbx .sk-ic{width:19px;height:19px;flex:0 0 auto;color:#0B7FA6;margin-top:2px}',
    ...
    '.sktbx .sk-card.main .sk-tag{background:#fff;color:#0B7FA6}',
    '.sktbx .sk-card.star .sk-tag{background:#fff;color:#0B7FA6}',
    '.sktbx .sk-chips{display:flex;flex-wrap:wrap;gap:6px}',
    '.sktbx a.sk-chip{font-size:.8rem;font-weight:600;color:#0B7FA6;background:var(--cyan-100);',
      'border-radius:999px;padding:4px 12px;text-decoration:none;transition:.18s}',
    '.sktbx a.sk-chip:hover{background:#0B7FA6;color:#fff}',
    '.sktbx a.sk-go{margin-top:auto;padding-top:4px;font-size:.83rem;font-weight:700;color:#0B7FA6;text-decoration:none}',
